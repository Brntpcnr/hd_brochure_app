...
void main() {
  runApp(const OldDetail1());
}

class OldDetail1 extends StatelessWidget {
  const OldDetail1({Key? key}) : super(key: key);
          ...
          children: [
            Center(
              child: Padding(
                ...
                child: Text("IRON 883", style: TextStyle(
                    color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold, fontStyle: FontStyle.italic)),
              ),
            ),
            Image.asset("assets/iron-883.png", width: 400, height: 300),
            const ListTile(
              title: Text(
                "Iron 883™ ",
              ...
              subtitle: Padding(
                ...
                child: Text(
                    "Feel the purity of the two wheels, the handlebars and the engine.",
                    style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: Colors.black)
                ),
              ),
            ),
              ...
              children: <Widget>[
                Column(
                  children: <Widget>[
                    ...
                    Text('883CC', style: TextStyle(fontWeight: FontWeight.bold)),
                  ],
                ),
                Column(
                  children: <Widget>[
                    ...
                    Text('54 HP / 37 kW', style: TextStyle(fontWeight: FontWeight.bold)),
                  ],
                ),
                Column(
                  children: <Widget>[
                    ...
                    Text('68 Nm', style: TextStyle(fontWeight: FontWeight.bold)),
                  ],
                ),
              ],
            )
